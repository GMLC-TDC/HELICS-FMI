...
@details if val is between the two limits it returns val if it is not it returns the appropriate
limit requires that the < operator be defined on the type
...
@details this could be used with other types if they define a constructor which take and integer
argument and a less than operator and != operator
...
/** check that a vector has the requested number of elements if not resize it with all new elements
 * having value = defArg*/
template<class X>
...
/** calculate the maximum absolute difference between values in two vectors and return the maximum
difference and the location
...
{
    X prod_of_vector =
        std::accumulate(a.begin(), a.end(), X(0), [](X a1, X a2) { return a1 * a2; });
...
{
    X sum_of_vector =
        std::accumulate(a.begin(), a.end(), 0.0, [](X a1, X a2) -> X { return (a1 + a2 * a2); });
...
/** generate a vector of indices where the values of a vector are not equal to a given value within
a defined range
@param a the vector of value to compare
@param match the matching value
...
/** generate a vector of indices where the values of a vector are less than or equal to a given
value
@param a the vector of value to compare
@param match the comparison value
@return a vector of indices into a with the matching condition
...
/** generate a vector of indices where the values of a vector are greater than or equal to a given
value
@tparam X the type of the values
@tparam Y the type of the indices desired
@param a the vector of value to compare
...
/** count the differences between two vectors if the difference is greater than a tolerance, ignore
a common mode difference between the two
@param a the first vector
@param b the second vector
@param maxAllowableDiff the tolerable difference between two values
@return the number of differences*/
...
/** count the differences between two vectors if the difference is greater than a tolerance and the
a value is valid (ie !=0)
@param a the first vector
@param b the second vector
@param maxAllowableDiff the tolerable difference between two values
@return the number of differences*/
...
/** count the differences between two vectors if the difference is greater than a tolerance and call
a callback function for each difference
@param a the first vector
@param b the second vector
@param maxAllowableDiff the tolerable difference between two values
@param  f the callback function takes 3 arguments the index and the values for each of the two
...
/** count the differences between two vectors if the difference is greater than a tolerance and the
a value is valid (ie !=0) and call a callback function for each difference
@param a the first vector
@param b the second vector
@param maxAllowableDiff the tolerable difference between two values
@param  f the callback function takes 3 arguments the index and the values for each of the two
...
move them if possible.  If they are not the same type do a static cast in a transform to make a new
vector the code use SFINAE magic with the std::false_type and std::true_type to discriminate which
overload to use the function below them vectorConvert include a type_trait check for if the vector
types are the same
*/
