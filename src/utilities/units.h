...
@return the numerical value of the property in output units,  badConversion if unable to convert
...
/** @brief convert between units used in power systems related to power, current, voltage, and
resistance.
@param[in] val  the value of the property in input units
@param[in] in the units of val
@param[in] out the units of the desired result
...
@param[in] in the units of val
@param[in] out the units of the desired result
@param[in] basePower  the base power in MVA to use when converting between units involving pu
notation
@return the numerical value of the property in output units,  badConversion if unable to convert
between the specified units
*/
