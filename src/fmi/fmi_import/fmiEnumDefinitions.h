...
BETTER_ENUM(fmi_variability, int, continuous = 0,
    constant,
    fixed,
    tunable,
    discrete,
...
BETTER_ENUM(fmi_causality, int, local,
        parameter,
        calculatedParameter,
        input,
        output,
...
BETTER_ENUM(fmi_variable_type, int, real = 0,
    integer,
    boolean,
    string,
    enumeration,
...
BETTER_ENUM(fmi_dependency_type, int, dependent = 0,
    constant,
    fixed,
    tunable,
    discrete,
