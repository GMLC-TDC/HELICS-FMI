...
public:
    ...
    int index{ -1 };
    fmiVariable()=default;
    fmiVariable(fmi2ValueReference ref, fmi_variable_type type1, int startIndex) :vRef{ ref }, type(type1), index{ startIndex }{}
    fmiVariable(const variableInformation &var):vRef{var.valueRef},type(var.type),index(var.index){}
};
