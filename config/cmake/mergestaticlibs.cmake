...
# You should have received a copy of the FMILIB_License.txt file along with this program. If not,
# contact Modelon AB <http://www.modelon.com>.

# Merge_static_libs(outlib lib1 lib2 ... libn) merges a number of static libs into a single static
# library
function(merge_static_libs outlib)
    ...
    elseif(APPLE)
        ...
        foreach(lib ${libfiles})
            ...
            if(${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/cmake.check_cache IS_NEWER_THAN
               ${objlistcmake}
            )
                # ---------------------------------
                file(
...
EXECUTE_PROCESS(COMMAND ls .
                ...
                add_custom_command(
                    OUTPUT ${objlistfile} COMMAND ${CMAKE_COMMAND} -P ${objlistcmake}
                    DEPENDS ${lib}
                )
            endif()
    ...
    add_custom_command(
        OUTPUT ${dummyfile} COMMAND ${CMAKE_COMMAND} -E copy ${dummyfile}.base ${dummyfile}
