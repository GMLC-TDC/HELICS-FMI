...
if (MSVC_VERSION LESS_EQUAL 1929)
	set(HELICS_CPP_FILE "${HELICS_DOWNLOAD_BASE}/Helics-${HELICS_CURRENT_VERSION}-msvc2019-win64.zip")
	set(HELICS_CPP_SHA 036990acee88a667af17d13fb9d1c67dce6824a596583310003aa02fd97a42d4)
else()
   set(HELICS_CPP_FILE "${HELICS_DOWNLOAD_BASE}/Helics-${HELICS_CURRENT_VERSION}-msvc2022-win64.zip")
...
FetchContent_Declare(
  helicscpp
  URL      ${HELICS_CPP_FILE}
  URL_HASH  SHA256=${HELICS_CPP_SHA}
)
