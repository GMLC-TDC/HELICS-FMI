...
breathe_default_project = "helics-fmi"
...
htmlhelp_basename = "helicsfmidoc"
...
latex_documents = [
    (master_doc, "helics-fmi.tex", "HELICS-FMI documentation", "Philip Top", "manual")
]
...
man_pages = [(master_doc, "helics-fmi", "HELICS-FMI documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "helics-fmi",
        "HELICS-FMI documentation",
        author,
        "HELICS_FMI",
        "interface application for connecting FMU's to HELICS",
        "Miscellaneous",
    )
]
